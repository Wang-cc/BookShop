...
import com.neil.bookshop.service.OrderService;
...
public class OrderServlet extends BaseServlet {
	...
	public void createOrder(HttpServletRequest request, HttpServletResponse response)
		...
		for (Product p : cart.keySet()) {
			...
			oi.setProduct(p);   //把购物车中的商品对象添加到OrderItem中
	...
	public void findOrderItemsByOrderId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
